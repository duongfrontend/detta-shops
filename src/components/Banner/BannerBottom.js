...
const BannerBottom = () => {
  return (
    <div className="w-full bg-white border-b-[1px] py-4 border-b-gray-200 px-4">
      <div className="banner-media max-w-container mx-auto h-20 flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="flex md:w-auto items-center gap-2 w-72 shadow-sm hover:shadow-md duration-300">
          ...
          <p className="text-lightText text-base">Đổi trả dễ dàng</p>
        </div>
      </div>
    </div>
  );
